...
ent-PaperSalvageJobLabel = этикетка отправки материалов в утиль
    .desc = Бумажная этикетка, указывающая на то, что ящик содержит груз, предназначенный для выполнения работ по утилизации. Продажа ящика с такой этикеткой позволит выполнить эту работу.
