...
public static class SpeciesDescriptionGenerator
{
    ...
    private static IEnumerable<string> GenerateDamageModifiers(
        ...
        IComponentFactory componentFactory)
    {
        ...
        foreach (var (damageType, coefficient) in modifierSet.Coefficients)
        {
            ...
            yield return coefficient < 1f
                ? Loc.GetString("ui-species-generated-damage-resistant", ("percent", percent), ("damage", damageName))
                : Loc.GetString("ui-species-generated-damage-vulnerable", ("percent", percent), ("damage", damageName));
        }
    }

    private static IEnumerable<string> GenerateTemperature(
        EntityPrototype mobProto,
        IPrototypeManager prototypes,
        IComponentFactory componentFactory)
    {
        ...
        if (MathF.Abs(temperature.HeatDamageThreshold - HumanHeatThreshold) > FloatTolerance)
        {
            ...
            yield return temperature.HeatDamageThreshold > HumanHeatThreshold
                ? Loc.GetString("ui-species-generated-heat-threshold-higher", ("temperature", celsius))
                : Loc.GetString("ui-species-generated-heat-threshold-lower", ("temperature", celsius));
        }
        ...
        if (MathF.Abs(temperature.ColdDamageThreshold - HumanColdThreshold) > FloatTolerance)
        {
            ...
            yield return temperature.ColdDamageThreshold > HumanColdThreshold
                ? Loc.GetString("ui-species-generated-cold-threshold-higher", ("temperature", celsius))
                : Loc.GetString("ui-species-generated-cold-threshold-lower", ("temperature", celsius));
        }
    ...
    private static IEnumerable<string> GenerateTemperatureDamage(
        ...
        foreach (var (damageType, amount) in damage.DamageDict)
        {
            ...
            if (overheating)
            {
                yield return amountFloat > humanAmount
                    ? Loc.GetString("ui-species-generated-overheat-damage-more", ("amount", formattedDelta), ("damage", damageName))
                    : Loc.GetString("ui-species-generated-overheat-damage-less", ("amount", formattedDelta), ("damage", damageName));
            }
            else
            {
                yield return amountFloat > humanAmount
                    ? Loc.GetString("ui-species-generated-cold-damage-more", ("amount", formattedDelta), ("damage", damageName))
                    : Loc.GetString("ui-species-generated-cold-damage-less", ("amount", formattedDelta), ("damage", damageName));
            }
        }
    }

    private static IEnumerable<string> GenerateHungerAndThirst(
        EntityPrototype mobProto,
        IComponentFactory componentFactory)
    {
    ...
    private static IEnumerable<string> GenerateMovement(
        EntityPrototype mobProto,
        IComponentFactory componentFactory)
    {
    ...
    private static IEnumerable<string> GenerateStamina(
        EntityPrototype mobProto,
        IComponentFactory componentFactory)
    {
        ...
        yield return stamina.BaseCritThreshold > HumanStaminaThreshold
            ? Loc.GetString("ui-species-generated-stamina-threshold-higher", ("stamina", threshold))
            : Loc.GetString("ui-species-generated-stamina-threshold-lower", ("stamina", threshold));
    }

    private static IEnumerable<string> GeneratePuller(
        EntityPrototype mobProto,
        IComponentFactory componentFactory)
    {
        ...
        yield return Loc.GetString("ui-species-generated-pulling-without-hands");
    }

    private static IEnumerable<string> GenerateFlammable(
        EntityPrototype mobProto,
        IPrototypeManager prototypes,
        IComponentFactory componentFactory)
    {
        ...
        yield return flammable.FirestacksOnIgnite > HumanFirestacksOnIgnite
            ? Loc.GetString("ui-species-generated-ignites-easier", ("percent", percent))
            : Loc.GetString("ui-species-generated-ignites-harder", ("percent", percent));

        foreach (var line in GenerateBurningDamage(flammable.Damage, prototypes))
            yield return line;
    }

    private static IEnumerable<string> GenerateBurningDamage(DamageSpecifier damage, IPrototypeManager prototypes)
    {
        foreach (var (damageType, amount) in damage.DamageDict)
        {
            var amountFloat = (float) amount;
            ...
            yield return amountFloat > HumanBurnDamage
                ? Loc.GetString("ui-species-generated-burning-damage-more", ("amount", formattedDelta), ("damage", damageName))
                : Loc.GetString("ui-species-generated-burning-damage-less", ("amount", formattedDelta), ("damage", damageName));
        }
    }

    private static IEnumerable<string> GenerateFlags(
        EntityPrototype mobProto,
        IComponentFactory componentFactory)
    {
        if (mobProto.Components.ContainsKey("Uncloneable"))
            yield return Loc.GetString("ui-species-generated-uncloneable");

        if (mobProto.TryGetComponent(out SericultureComponent? _, componentFactory))
            yield return Loc.GetString("ui-species-generated-sericulture");

        if (mobProto.TryGetComponent(out JumpAbilityComponent? _, componentFactory))
            yield return Loc.GetString("ui-species-generated-jump-ability");

        if (mobProto.TryGetComponent(out StorageComponent? _, componentFactory))
            yield return Loc.GetString("ui-species-generated-internal-storage");

        if (!mobProto.Components.ContainsKey("Perishable"))
            yield return Loc.GetString("ui-species-generated-no-rotting");
    }

    private static IEnumerable<string> GenerateRateComparison(
        float value,
        float humanValue,
        string fasterKey,
        string slowerKey)
    {
        ...
        yield return value > humanValue
            ? Loc.GetString(fasterKey, ("percent", percent))
            : Loc.GetString(slowerKey, ("percent", percent));
    }

    private static IEnumerable<string> GeneratePercentComparison(
        float value,
        float humanValue,
        string fasterKey,
        string slowerKey)
